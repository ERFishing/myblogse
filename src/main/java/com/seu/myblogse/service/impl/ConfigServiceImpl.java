...
import com.seu.myblogse.mapper.BlogConfigMapper;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String yourEmail = "zmqErica_ouc@126.com";
    public static final String yourName = "ERFishing";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "浙ICP备 xxxxxx-x号";
    public static final String footerCopyRight = "@2020 ERFishing";
